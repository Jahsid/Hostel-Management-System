...
function Invoices() {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-3 items-center justify-center pt-20">
            ...
            : pendingInvoices.map((invoice) => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <button className="group/show relative z-0" onClick={() => approveInvoice(invoice._id)}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
