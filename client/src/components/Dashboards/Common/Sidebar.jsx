...
function Sidebar({ links }) {
  ...
  return (
    <div className="h-screen ">
      ...
      <div
        className={`flex flex-col justify-between h-full w-screen absolute md:static sm:w-64 bg-black text-white transition-transform duration-300 ease-in-out z-40 transform ${
