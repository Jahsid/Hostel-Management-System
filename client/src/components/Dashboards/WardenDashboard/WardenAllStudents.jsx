...
function AdminAllStudents() {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-5 items-center justify-center pt-20">
            ...
            <li className="py-3 px-5 rounded sm:py-4 hover:bg-neutral-700 hover:scale-105 transition-all" key={student._id}>
              <div className="flex items-center space-x-4">
                ...
                <div className="flex gap-3">
                  {/* <button className="hover:underline hover:text-green-600 hover:scale-125 transition-all" onClick={() => updateStudent()}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
