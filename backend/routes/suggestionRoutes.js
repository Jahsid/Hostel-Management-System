...
const { registerSuggestion, getbyhostel, getbystudent, updateSuggestion, suggestionCount } = require('../controllers/suggestionController');
...
router.get('/suggestionCount', suggestionCount);
