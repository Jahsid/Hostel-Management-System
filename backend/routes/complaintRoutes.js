...
const { registerComplaint, getbyhostel, getbystudent, resolve, complaintCount } = require('../controllers/complaintController');
...
router.get('/complaintCount', complaintCount);
