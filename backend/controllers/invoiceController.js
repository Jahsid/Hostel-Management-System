...
const { Invoice, MessOff, Student, Attendance } = require("../models");
...
exports.generateInvoices = async (req, res) => {
  ...
  students.map(async (student) => {
    ...
    let amount = Mess_bill_per_day * attendance.length;
...
exports.updateInvoice = async (req, res) => {
  ...
  try {
    let invoice = await Invoice.findByIdAndUpdate(student, { status: status });
